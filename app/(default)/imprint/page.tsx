        ...
        <div className="mt-2 space-y-6 text-sm leading-6">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              these pages in accordance with general laws. However, we are not
              ...
              possible from the time we become aware of a specific infringement.
              Upon becoming aware of such legal violations, we will remove the
              content immediately.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold">5. Liability for Links</h2>
            <p className="mt-2">
              Our website contains links to external third-party websites whose
              content we cannot influence. Therefore, we cannot assume any
              ...
              content. Illegal content was not identifiable at the time of
              linking. Permanent monitoring of linked pages is not reasonable
              without concrete evidence of a violation. If we become aware of
              any infringements, we will remove such links immediately.
            </p>
          </section>

          <section>
            <h2 className="text-base font-semibold">6. Copyright</h2>
            <p className="mt-2">
              ...
              distribution, or any kind of exploitation outside the limits of
              copyright law require the prior written consent of the respective
              author or creator. Downloads and copies of this site are only
              permitted for private, non-commercial use. Where content on this
              site was not created by the operator, third-party copyrights are
              respected and such content is marked accordingly.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              This website is hosted by Vercel. Project-related data is stored
              in a MongoDB database. Where required, data processing is carried
              out on the basis of applicable data processing agreements pursuant
              to Art. 28 GDPR.
            </p>
          </section>
